...
const MjAll = ({
  ...
  maxHeight,
  usemap,
}: MjAllProps): ReactElement =>
  createElement('mj-all', {
    align,
    border,
    cellpadding,
    cellspacing,
